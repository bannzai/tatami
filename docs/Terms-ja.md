...
1.	「本サービス」とは、提供者が提供する【Tatami】という名称のサービス（理由の如何を問わずサービスの名称または内容が変更された場合は、当該変更後のサービスを含みます。）をいいます。
...
3.	本サービスは、提供者のサーバーへ利用者情報を送信しません。ユーザーが本アプリを通じて閲覧する各ウェブサイトの運営者による情報の取扱いは、各ウェブサイトの規約およびプライバシーポリシーに従うものとし、提供者はこれについて責任を負いません。
